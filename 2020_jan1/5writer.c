...
int main(int argc, char **argv){
    ...
    checkError(sem_init(&sharedObj->inDataReady,1,1)!=-1,"sem init"); //spreman za slanje
    checkError(sem_init(&sharedObj->dataProcessed,1,0)!=-1,"sem init"); //treba da se izracuna zeljeni string
